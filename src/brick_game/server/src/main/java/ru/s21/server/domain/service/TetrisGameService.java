...
import ru.s21.server.domain.util.TetrisLibraryInterface;

@Service
public class TetrisGameService implements GameService {
    private final TetrisLibraryInterface library = TetrisLibraryInterface.INSTANCE;
